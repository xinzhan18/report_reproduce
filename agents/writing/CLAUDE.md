...
- **上游文件**: 读取 `literature/ideation.md`, `experiments/plan.md`, `experiments/experiment.md`, `experiments/factor_results.json`, `experiments/factor_code.py`
...
- 2026-03-02: 因子研究改造：prompt 重写为因子研究报告格式 (Factor Construction + Evaluation Results)，_build_state_summary 改为因子指标
